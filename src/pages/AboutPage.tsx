          ...
          >
            ...
            <div className="space-y-5 mb-12">
              <p className="text-[hsl(var(--muted-foreground))] text-base leading-relaxed">
                ...
                collaboration. I excel in conveying complex technical concepts
                with clarity, patience, and adaptability. By actively listening
                and engaging with my peers, I create an inclusive environment
                where diverse perspectives are welcomed.
              </p>
              <p className="text-[hsl(var(--muted-foreground))] text-base leading-relaxed">
                I leverage various communication channels — from face-to-face
                discussions to virtual platforms — to ensure effective
                information exchange. I foster positive relationships, promoting
                a supportive atmosphere where ideas are shared and clarified.
              </p>
            </div>
            ...
            <div className="space-y-5">
              <p className="text-[hsl(var(--muted-foreground))] text-base leading-relaxed">
                I am an engaged team member, contributing actively and
                effectively communicating with my peers. I excel in adapting to
                different perspectives, valuing diverse ideas, and working
                towards shared goals.
              </p>
              <p className="text-[hsl(var(--muted-foreground))] text-base leading-relaxed">
                By leveraging the strengths and expertise of each team member,
                we foster creativity, innovation, and problem-solving. I am
                skilled in coordinating tasks, delegating responsibilities, and
                maintaining efficient communication channels in a supportive,
