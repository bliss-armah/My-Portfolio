  ...
  return (
    <div className="w-[48%]">
      <form onSubmit={handleSubmit}>
        <div className="bg-[#bcccdc] p-16 rounded-md flex flex-col">
          ...
          <button
            type="submit"
            className="flex justify-center items-center right-0 bg-[#243a52] p-6 w-[120px] h-6 rounded-lg  text-[white] uppercase hover:bg-[#617d98]"
          >
            Upload
          </button>
        </div>
